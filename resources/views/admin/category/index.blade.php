                    ...
                    @foreach ($categories as $category)
                      <tr>
                        ...
                        <td>
                            ...
                            @if($category->status == 1)
                            <a href="{{ url('/categories/inactive/'.$category->id) }}" class="btn btn-sm btn-danger">Inactive</a>
                            @else
                            <a href="{{ url('/categories/active/'.$category->id) }}" class="btn btn-sm btn-success">Active</a>
                            @endif
                        </td>
                      </tr>
                      @endforeach
